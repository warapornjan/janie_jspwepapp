                                        ...
                                        <form>
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9"><input type="text" class="form-control" id="books_id" value="${param.books_id}"> </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9"> <input type="text"  class="form-control" id="bookname" value="${param.bookname}"></textarea></div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-3"> <label for="message-text" class="control-label">Author:</label></div>
                                                    <div class="col-md-9"> <input type="text"  class="form-control" id="author" value="${param.author}"></textarea></div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-3"> <label for="message-text" class="control-label">Price:</label></div>
                                                    <div class="col-md-9"> <input type="text"  class="form-control" id="price" value="${param.price}"></textarea></div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
